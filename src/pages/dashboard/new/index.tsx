...
const schema = z.object({
    ...
    whatsapp: z.string().min(1, 'O campo nome é obrigatório').refine((value) => /^(\d{11,12})$/.test(value), {
...
export function New() {
    ...
    async function handleUpload(image: File) {
        ...
        const updalodRef = ref(storage, `images/${currentUid}/${uidImage}`);

        uploadBytes(updalodRef, image)
            .then((snapshot) => {
